...
namespace DBPro.Database
{
    ...
    public class OracleHelper
    {
        ...
        #region bool RunProcedureBool
        public static bool RunProcedureBool(OracleConnection connection, string storedProcName, OracleParameter[] parameters)
        {

            Oracle.ManagedDataAccess.Types.OracleBoolean result;
            OracleCommand command = StoredProcReturnCommand(connection, storedProcName, OracleDbType.Boolean, parameters);
            command.ExecuteNonQuery();
            result = (Oracle.ManagedDataAccess.Types.OracleBoolean)command.Parameters["ReturnValue"].Value;
            return result.IsNull ? false : result.Value;
        }
        #endregion
